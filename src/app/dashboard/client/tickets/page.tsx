...
import { loadClientSupportTickets } from "@/app/actions";
...
export default function ClientTicketsPage() {
  ...
  useEffect(() => {
    const loadTickets = async () => {
      setLoading(true);
      const data = await loadClientSupportTickets();
      setTickets(data || []);
      setLoading(false);
    };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value as TicketStatus | "all")} className="w-full md:w-64 rounded-2xl border border-slate-300 px-4 py-2">
